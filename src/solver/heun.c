...
static int one_flag_step_heun(double *y, double dt, double *yval[2], int neq, double *tim, int *istart);
static void one_step_heun(double *y, double dt, double *yval[2], int neq, double *tim);
