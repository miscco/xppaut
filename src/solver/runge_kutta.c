...
static int one_flag_step_rk4(double *y, double dt, double *yval[3], int neq, double *tim, int *istart);
static void one_step_rk4(double *y, double dt, double *yval[3], int neq, double *tim);
